...
export const SignalRConnectionStatus: React.FC<ConnectionStatusProps> = ({ 
    ...
    const [connectionInfo, setConnectionInfo] = useState<ReturnType<typeof signalRService.getConnectionInfo> | null>(null);
                        ...
                        <button
                            onClick={async () => {
                                ...
                                await signalRService.startConnection(
                                    connectionInfo.staffDeviceId ?? undefined,
                                    connectionInfo.staffDeviceName ?? undefined
                                );
                            }}
