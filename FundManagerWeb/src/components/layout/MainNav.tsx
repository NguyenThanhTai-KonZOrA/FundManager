...
export function MainNav(): React.JSX.Element {
    ...
    const [tempThemeColor, setTempThemeColor] = useState<string>(primaryColor || '#274549');
    const [currentUserLogin, setCurrentUserLogin] = useState<string | null>(localStorage.getItem('user'));
    ...
    useEffect(() => {
        setTempThemeColor(primaryColor || '#274549');
    }, [primaryColor]);
    ...
    const handleSaveTheme = () => {
        setPrimaryColor(tempThemeColor);
    ...
    return (
        <>
            ...
            >
                <MenuItem sx={{ pointerEvents: 'none', opacity: 1, py: 1.5 }}>
                    <ListItemText>
                        <Typography variant="body1" fontWeight={800} sx={{ color: primaryColor || '#274549' }}>
                            Hello, {currentUserLogin || 'Unknown User'}!
                        </Typography>
                        <Typography variant="body2" color="text.secondary" fontWeight={800} sx={{ color: primaryColor || '#274549' }}>
                            {currentUserLogin ? `${currentUserLogin}@thegrandhotram.com` : 'admin@example.com'}
                        </Typography>
                    </ListItemText>
                </MenuItem>
                <Divider />
            ...
            >
                ...
                <DialogContent>
                    <Typography variant="body2" paragraph>
                        Pick a primary color for the application. This will be saved and applied across the site.
                    </Typography>
                    ...
                    <Box display="flex" alignItems="center" gap={2} mb={2}>
                        ...
                        />
                        <Box sx={{ width: 48, height: 40, bgcolor: tempThemeColor, borderRadius: 1, border: '1px solid rgba(0,0,0,0.12)' }} />
                        <Typography variant="body2">{tempThemeColor.toUpperCase()}</Typography>
                    </Box>

                    <Box display="flex" gap={1} flexWrap="wrap">
                        {['#274549', '#0d93c9', '#e53935', '#6a1b9a', '#ff9800', '#43a047'].map(c => (
                            <Button
                                key={c}
                                onClick={() => setTempThemeColor(c)}
                                variant={tempThemeColor === c ? 'contained' : 'outlined'}
                                sx={{ minWidth: 44, minHeight: 40, p: 0, bgcolor: c, borderColor: c }}
                            />
                        ))}
                    </Box>
                </DialogContent>
                <DialogActions>
                    <Button variant="outlined" onClick={() => setShowThemeDialog(false)} color="inherit">
                        Cancel
                    </Button>
