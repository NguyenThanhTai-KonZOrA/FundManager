...
import type { PermissionResponse, CreatePermissionRequest, UpdatePermissionRequest } from "../../types/rolePermissionType";
...
export default function AdminPermissionPage() {
    ...
    const loadPermissions = async () => {
        try {
            ...
            logError('AdminPermissionPage.loadPermissions', error);
            setError(extractErrorMessage(error, 'Failed to load permissions data'));
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleToggleStatus = async (permission: PermissionResponse) => {
        try {
            ...
            const result = await permissionService.togglePermissionStatusAsync(permission.id);
            ...
            logError('AdminPermissionPage.handleToggleStatus', error);
            showSnackbar(extractErrorMessage(error, 'Error updating permission status'), "error");
        } finally {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (dialogMode === "create") {
                ...
                const result = await permissionService.createPermissionAsync(request);
                ...
                const result = await permissionService.updatePermissionAsync(editingPermission.id, request);
                setPermissions(prev =>
            ...
            logError('AdminPermissionPage.handleSubmit', error);
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const result = await permissionService.deletePermissionAsync(deletingPermission.id);
            ...
            logError('AdminPermissionPage.handleDelete', error);
            showSnackbar(extractErrorMessage(error, 'Error deleting permission'), "error");
        } finally {
