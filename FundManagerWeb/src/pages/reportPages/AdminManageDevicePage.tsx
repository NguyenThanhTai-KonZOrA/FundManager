...
import { manageDeviceService } from "../../services/deviceMappingService";
import type { DeviceInfo, ToggleDeviceRequest, DeleteDeviceRequest, ChangeHostnameRequest } from "../../types/deviceType";
...
export default function AdminManageDevicePage() {
    ...
    const loadDevices = useCallback(async () => {
        try {
            setLoading(true);
            setError(null);
            const data = await manageDeviceService.getAllDevicesAsync();
    ...
    const handleToggleStatus = async (device: DeviceInfo) => {
        try {
            ...
            await manageDeviceService.changeStatusDeviceAsync(request);
            showSnackbar(
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            await manageDeviceService.deleteDeviceAsync(request);
    ...
    const handleConfirmChangeHostname = async () => {
        ...
        try {
            ...
            await manageDeviceService.changeHostnameAsync(request);
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {paginatedDevices.map((device) => (
                                                <TableRow key={`${device.id}-${device.deviceType}`} hover>
                                                    <TableCell>
