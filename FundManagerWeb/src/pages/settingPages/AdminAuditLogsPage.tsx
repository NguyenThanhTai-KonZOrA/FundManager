...
import type { AuditLogResponse, AuditLogPaginationRequest } from '../../types/auditLogsType';
...
const AdminAuditLogsPage: React.FC = () => {
    ...
    const loadAuditLogs = useCallback(async () => {
        try {
            ...
            const response = await auditLogService.getAuditLogsFilterOptionsAsync(request);
    ...
    }, [action, entityType, fromDate, isSuccess, page, rowsPerPage, toDate, userName]);
    ...
    const handleRowDoubleClick = async (log: AuditLogResponse) => {
        try {
            ...
            const detailLog = await auditLogService.getAuditLogByIdAsync(log.id);
                                ...
                                <Box display="flex" flexWrap="wrap" gap={2}>
                                    ...
                                    <Box sx={{ minWidth: 200, flex: '1 1 200px' }}>
                                        <TextField
                                            ...
                                            inputProps={{
                                                max: FormatUtcTime.getTodayWithTimeString() // Prevent selecting future dates
                                            }}
                                            onFocus={(e) => {
                                ...
                                <Table>
                                    <TableHead>
                                        <TableRow sx={{ bgcolor: `${muiTheme.palette.primary.main}`, "& .MuiTableCell-root": { color: "#fff", fontWeight: 600 } }}>
                                            ...
                                            <TableCell sx={{ minWidth: 100 }} align='center'>Entity Type</TableCell>
                                            <TableCell sx={{ minWidth: 100 }} align='center'>Method</TableCell>
                                            <TableCell sx={{ minWidth: 200 }}>Request Path</TableCell>
                                            ...
                                            <TableCell sx={{ minWidth: 60 }} align='center'>Actions</TableCell>
                                        </TableRow>
                                    </TableHead>
                                    <TableBody>
                                        {auditLogs.length === 0 ? (
                                            ...
                                            auditLogs.map((log) => (
                                                ...
                                                >
                                                    <TableCell sx={{ fontWeight: 400 }}>{log.userName || '-'}</TableCell>
                                                    ...
                                                    <TableCell sx={{ fontWeight: 400 }} align='center'>{getStatusChip(log.isSuccess)}</TableCell>
